...
if (PROJECT_COMPILER_CLANG)
    list(APPEND _PROJECT_WARNINGS ${CLANG_WARNINGS})
elseif (PROJECT_COMPILER_GCC)
    list(APPEND _PROJECT_WARNINGS ${GCC_WARNINGS})
endif ()
...
add_library(utility::project_warnings ALIAS project_warnings)
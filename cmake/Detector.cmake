...
IF ( PROJECT_SANITIZER_THREAD_ENABLED AND PROJECT_SANITIZER_THREAD_SUPPORTED )
    IF ( PROJECT_SANITIZER_ADDRESS_USING OR PROJECT_SANITIZER_UNDEFINED_USING )
        MESSAGE ( FATAL_ERROR "Try to using ThreadSanitizer with Address(Undefiend)Sanitizer")
    ENDIF ( )
    SET  ( PROJECT_SANITIZER_THREAD_USING ON      )
    SET  ( PROJECT_SANITIZER_USING ON                )
    LIST ( APPEND PROJECT_SANITIZER_LIST "thread" )
ELSEIF ( PROJECT_SANITIZER_THREAD_ENABLED AND NOT PROJECT_SANITIZER_THREAD_SUPPORTED )
    MESSAGE ( FATAL_ERROR "Try to using ThreadSanitizer but it's not supported" )
ENDIF ()

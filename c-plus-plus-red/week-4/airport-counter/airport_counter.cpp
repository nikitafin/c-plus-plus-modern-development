...
public:
  ...
  size_t Get(TAirport airport) const {
    return airportCount[int(airport)].second;
  }

  // добавить данный элемент
  void Insert(TAirport airport) { ++airportCount[int(airport)].second; }

  // удалить одно вхождение данного элемента
  void EraseOne(TAirport airport) { --airportCount[int(airport)].second; }
  ...
  Items GetItems() const { return airportCount; }

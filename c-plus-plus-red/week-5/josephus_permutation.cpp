...
void
MakeJosephusPermutation(RandomIt first, RandomIt last, uint32_t step_size) {
...
bool
operator==(const NoncopyableInt &lhs, const NoncopyableInt &rhs) {
  return lhs.value == rhs.value;
}

std::ostream &
operator<<(std::ostream &os, const NoncopyableInt &v) {
  return os << v.value;
}

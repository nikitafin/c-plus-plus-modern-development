...
void TestBasicSearch()
{
    const vector<string> docs
        = {"we are ready to go",
           ...
           "i love this game",
           "just like exception safety is not about writing try catch everywhere in your "
           "code move semantics are not about typing double ampersand everywhere in your "
           "code",
    ...
    const vector<string> queries = {
        "we need some help", "it", "i love this game", "tell me why", "dislike", "about"};

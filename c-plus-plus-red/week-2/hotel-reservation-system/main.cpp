...
void HotelReservationSystem::Book(
...
int64_t HotelReservationSystem::Clients(const std::string & hotel_name) const
{
...
int64_t HotelReservationSystem::Rooms(const std::string & hotel_name) const
{
...
void HotelReservationSystem::updateReservationQuery()
{

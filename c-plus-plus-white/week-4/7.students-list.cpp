...
main() {
  ...
  for (auto &student : students) {
    std::cin >> student.firstName >> student.lastName >> student.day >>
  ...
  for (int i = 0; i < cmdCount; ++i) {
    ...
    if ((cmd != "name" and cmd != "date") or studentNumber > studentsCount or
        studentNumber < 1) {
      ...
      std::cout << students[studentNumber - 1].day << "."
                << students[studentNumber - 1].month << "."

...
void
NewBus(dict &bus_stops, dict &stop_buses, const std::string &bus,
...
void
BusesForStop(const dict &stop_buses, const std::string &stop) {
...
void
StopsForBus(const dict &bus_stops, const dict &stop_buses,

...
void
Add(syns &synonyms, const std::string &f_word, const std::string &s_word) {
  synonyms[f_word].insert(s_word);
  synonyms[s_word].insert(f_word);
}
void
Count(const syns &synonyms, const std::string &word) {
...
void
Check(const syns &synonyms, const std::string &f_word,
      const std::string &s_word) {
